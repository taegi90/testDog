...
<form action="insert.do" method="post" name="writeForm" enctype="multipart/form-data">
<table>
	<tr>
		<td colspan="2">
		...
		<td class="td_right">
		<input type="file" name="image_tmp" id="image"/>
		</td>
		</tr>
		<tr>
		...
		<input type = "button" value ="개 상품목록보기" onClick="window.location.href='list.do'"/>
	</td>
	</tr>
	</table>
	</form>
